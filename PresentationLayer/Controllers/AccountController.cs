...
namespace PresentationLayer.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //        ViewBag.ReturnUrl = returnUrl;
        //        return View("ExternalLoginConfirmation", new RegisterExternalLoginModel { UserName = result.u, ExternalLoginData = loginData });
        //    }
        //}
        ...
        //                db.UserProfiles.Add(new UserProfile { UserName = model.Email });
        //                db.SaveChanges();
